...
ALTER TABLE `blocks` CHANGE `num_destroyed` `num_destroyed` BIGINT UNSIGNED DEFAULT '0';
ALTER TABLE `blocks` CHANGE `num_placed` `num_placed` BIGINT UNSIGNED DEFAULT '0';
...
ALTER TABLE `players` CHANGE `num_secs_loggedon` `num_secs_loggedon` BIGINT UNSIGNED DEFAULT '0';
ALTER TABLE `players` CHANGE `distance_traveled` `distance_traveled` BIGINT UNSIGNED DEFAULT '0';
